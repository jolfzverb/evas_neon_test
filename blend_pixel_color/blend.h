...
void _op_blend_rel_p_c_dp(DATA32 *s, DATA8 *m EINA_UNUSED, DATA32 c EINA_UNUSED, DATA32 *d, int l);
void _op_blend_rel_p_c_dp_neon(DATA32 *s, DATA8 *m, DATA32 c, DATA32 *d, int l);
